...
export function createTag(params) {
  return request('/api/api/create/tag',{method:'POST',body:params})
}

export function updateTag(params) {
  return request('/api/api/update/tag',{method:'POST',body:params})
}

export function deleteTag(params) {
  return request('/api/api/delete/tag',{method:'POST',body:params})
}
...
export function updateQuntityStock(val) {
  return request('/api/api/updateQty', {method: 'POST' ,body: val });
}
