...
import {Empty, Card, Form,Typography, Alert,Input, DatePicker, Space, InputNumber, Button, Table, Radio, Divider ,Switch, message, Row, Col, Avatar, Pagination, Tabs, Modal, Popconfirm , Select } from 'antd';
    ...
    getSnapshotBeforeUpdate(prevProps, prevState) {
        if(this.props.transaction.transaction && this.props.transaction.transaction.buss){
            ...
            this.setState({ name:business.username,
                email:business.bussnessInfo[0].bemail,
                contact:business.bussnessInfo[0].phone,
                ifsc:business.bussnessInfo[0].ifsc,
                account_number:business.bussnessInfo[0].acNumber,
