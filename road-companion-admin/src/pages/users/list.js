...
class UsersList extends React.Component {
  constructor(props) {
	...
	const columns = [
	  {
		title: <strong className="primary-text cursor" onClick={this.ChangeOrder}>Users Name <i className={' fal fa-sm '+(this.state.sortBy === 'asc'? "fa-long-arrow-up":"fa-long-arrow-down")} ></i></strong>,
		dataIndex: 'username',
